        ...
        <div className="w-full max-w-md mx-auto relative z-10">
            ...
            <div className="bg-[#0A0A0A]/90 backdrop-blur-2xl border border-white/10 rounded-2xl p-6 md:p-8 shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden group animate-in fade-in zoom-in-95 duration-500">
                ...
                <button
                    ...
                    disabled={isLoading}
                    className="relative z-10 w-full bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] hover:opacity-90 text-white font-bold py-3.5 rounded-xl transition-all duration-300 flex items-center justify-center gap-3 mb-8 shadow-[0_4px_20px_rgba(253,29,29,0.2)] hover:shadow-[0_4px_25px_rgba(253,29,29,0.3)] transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
                >
