# Protocolo de Economía y Monetización: Speedlight Culture
...
*   **Creador / Partner:** Usuarios que monetizan su contenido o servicios.

## 3. Moneda y Flujo de Valor (The Speedlight Loop)

### A. Ingresos (Input)
1.  **Publicidad Nativa (B2B):** Marcas pagan por espacios orgánicos (no intrusivos).
...
*   El formato debe ser tan bueno que el usuario a veces *quiera* verlo (ej: Lanzamiento de un nuevo modelo de coche).

---
*Este documento rige la lógica financiera del backend y las integraciones de pasarelas de pago.*
